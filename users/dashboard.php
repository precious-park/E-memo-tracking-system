      ...
      <main class="flex-grow">
        <div class="max-w-7xl mx-auto px-6 py-8">
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-lg font-semibold mb-4 text-gray-700">Your Dashboard</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div class="bg-white shadow rounded-xl p-6">
                <h2 class="text-sm font-medium text-gray-500">Total Memos</h2>
                <p class="mt-2 text-2xl font-bold text-gray-800">120</p>
              </div>
              <div class="bg-white shadow rounded-xl p-6">
                <h2 class="text-sm font-medium text-gray-500">Pending</h2>
                <p class="mt-2 text-2xl font-bold text-yellow-600">35</p>
              </div>
            </div>
          </div>
        </div>
